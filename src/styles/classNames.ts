export const chatbotViewClassNames = {
  ...
  sendButton: 'bg-zinc-800 hover:bg-zinc-700 text-white px-4 py-2 rounded font-bold',
};
export const notesGridViewClassNames = {
  ...
  addNoteButton: "px-4 py-1 bg-zinc-700 hover:bg-zinc-600 text-zinc-100 text-sm font-semibold transition-all focus:outline-none focus:ring-2 focus:ring-zinc-500 border border-zinc-600 shadow-none rounded-none",
...
export const quoteMonitorViewClassNames = {
  ...
  tickerInput: 'bg-zinc-800 text-zinc-200 px-2 py-0.5 rounded text-xs border border-zinc-700 focus:outline-none w-24',
